...
25 功能描述 :给定一个正整数 n ，输出外观数列的第 n 项。
 *
 ...
 *                          
            ...
            public static String countAndSay(int n){
                if (n == 1){
                    ...
                    while (right < len){
                        if (lastStr.charAt(start) != lastStr.charAt(right)){
                            result.append(right-start).append(lastStr.charAt(start));
                            start = right;
                        }
                        right++;
                    }
...
29. 给定两个以字符串形式表示的非负整数 num1 和 num2，返回 num1 和 num2 的乘积，它们的乘积也表示为字符串形式。
 * 输入: num1 = "2", num2 = "3"
 * 输出: "6"
 *
 ...
 * 输出: "56088"
              ...
              public static String multiply(String num1,String num2){
                    ...
                    for (int i = 0; i < length1; i++) {
                        if (map.containsKey(num1.charAt(i))){
                          number1 =  number1 * 10 + map.get(num1.charAt(i));
                        }
                    }
                    for (int i = 0; i < length2; i++) {
                        if (map.containsKey(num2.charAt(i))){
                            number2 =  number2 * 10 + map.get(num2.charAt(i));
                        }
                    }
